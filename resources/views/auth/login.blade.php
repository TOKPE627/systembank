...
<div class="flex items-center h-screen w-auto justify-center bg-teal-lighter">
    <div class="w-auto bg-white rounded shadow-lg p-8 m-4 md:max-w-sm md:mx-auto">
        ...
        <div class="flex flex-shrink-0 justify-center">
            <img src="{{asset('img/brand/logosenlog_max.png')}}" alt="" class="h-12 w-auto justify-center ml-ç4">
        </div>
        <h1 class="block w-full text-center text-grey-darkest mb-6 mt-4">Banking system !!</h1>
        ...
        <a class="link link-grey" href="{{url('forgot_password')}}">Forget Password?</a>
        <button class="modal-open bg-transparent border border-gray-500 hover:border-indigo-500 text-blue-500
            hover:text-indigo-500 font-bold py-2 px-4 rounded-full">No account?</button>
    </div>
</div>
