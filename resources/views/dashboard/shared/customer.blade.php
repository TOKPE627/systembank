...
@section('content')
    <div class="box-body">
        ...
        <div class="container-fluid">
            <p><i class="fa fa-plus-circle"> Customers Details</i></p>
            ...
            <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">View Customers and accounts</h6>
                    </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{route('customer.destroy','test')}}" method="post">
                                ...
                                <div class="modal-body">
                                    <p class="text-center">
                                        Are you to sure to delete this customer ?
                                    </p>
